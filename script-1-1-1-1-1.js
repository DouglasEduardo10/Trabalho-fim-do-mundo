        ...
        alternativas: [
            {
                ...
                afirmacao: "Iria em busca de estudos e conhecimento para ajudar."
            },
            {
                texto: "Não faria questão de ajudar, afinal não somos preparados para lidar com isso.",
                afirmacao: "Não faria questão de ajudar, afinal não somos preparados para lidar com isso."
            }
        ]
    },
    {
        enunciado: "Se acontecer um apagão mundial, você está animado para viver uma vida mais simples e desconectada?",
        alternativas: [
            {
                texto: "Sim, mal posso espera por isso!",
                afirmacao: "Sim, mal posso espera por isso!"
            },
            {
                texto: "Claro, seria uma experiência única!",
                afirmacao: "Claro, seria uma experiência única!"
            }
        ]
    },
    {
